...
CFLAGS = "-i . -I- -i include -ir include/loader -ir include/caddie -ir include/lib -proc gekko -Cpp_exceptions off -enum int -O4,s -use_lmw_stmw on -fp hard -rostr -sdata 0 -sdata2 0 -msgstyle gcc"
SRC_DIR = "src/"
BUILD_DIR = "build/"
RIIVO_DIR = "riivo/"
