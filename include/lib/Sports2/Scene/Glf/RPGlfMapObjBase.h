#ifndef RP_SPORTS_GLF_MAP_OBJ_BASE_H
#define RP_SPORTS_GLF_MAP_OBJ_BASE_H
#include "types_RP.h"

#include <nw4r/math/math_types.h>

/**
 * @brief Base class for Golf map (PMP) objects
 */
class RPGlfMapObjBase {
public:
    RPGlfMapObjBase();
...
private:
    ...
    nw4r::math::VEC3* mpOffset; // at 0x4C
};
